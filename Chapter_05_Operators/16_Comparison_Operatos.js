// Compasion Operator (will always give the result in the boolean, true or false)

// =, ==, ===


// = -> Assignment opearator
// == -> losse comparsion (No Datatype check, only value check)
// === -> strict comparsion ( value + datatype check )
